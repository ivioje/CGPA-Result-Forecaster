    ...
    years.value
      ...
      <div>
        ${
          firstClass > 4.9
            ? ''
            : `<p>You'll need <strong>${firstClass}</strong> to remain at a <strong>1st class</strong> for each of the semesters left</p>`
        }

        <p>You'll need <strong>${averageGPA(
          years.value,
          3.52
        )}</strong> to remain at a <strong>2nd class upper</strong> for each of the semesters left</p>

        <p>You'll need <strong>${averageGPA(
          years.value,
          2.52
        )}</strong> to remain at a <strong>2nd class lower</strong> for each of the semesters left</p>
